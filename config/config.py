class Config(object):
    ...
    train_root = '/Users/admin/data/peopleface/face'
    train_list = '/Users/admin/data/peopleface/face/train.txt'
    ...
    lfw_root = '/Users/admin/data/peopleface/face'
    lfw_test_list = '/Users/admin/data/test_project/arcface-pytorch/sample_test.csv'

    checkpoints_path = './checkpoints'
    load_model_path = 'models/resnet18.pth'
    test_model_path = 'checkpoints/resnet18_10.pth'
